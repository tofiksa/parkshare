...
export default function ParkingSpotDrawMap({
  ...
  }, [center, initialPolygon, polygonFromInput])
  ...
  const updateTempPolyline = useCallback(() => {
    ...
    if (vertices.length > 1) {
      ...
      // Change color if self-intersecting
      const isSelfIntersecting = vertices.length === 4 && checkSelfIntersection(vertices)
      const color = isSelfIntersecting ? "#ef4444" : "#10b981" // Red if intersecting, green otherwise
          ...
          <>
            <button
              ...
              disabled={
                ...
                (verticesRef.current.length === 4 && checkSelfIntersection(verticesRef.current))
              }
