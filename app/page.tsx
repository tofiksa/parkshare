    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
      ...
      <main className="flex flex-col items-center justify-center px-4 py-16 sm:py-24">
        <div className="max-w-6xl w-full">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
              ...
              <ul className="mt-4 space-y-2 text-sm text-gray-700">
                ...
                <li className="flex items-center">
                  ...
                  Start/stop parkering - betal kun for faktisk tid
                </li>
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-600 mr-2" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
          ...
          <div className="text-center bg-gradient-to-r from-purple-600 to-purple-700 rounded-2xl p-12 text-white shadow-xl mb-16">
            <div className="inline-block w-16 h-16 bg-white/20 rounded-xl flex items-center justify-center mb-6">
              <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
              </svg>
            </div>
            <h2 className="text-3xl font-bold mb-4">Ny funksjon: Start/Stop parkering</h2>
            <p className="text-lg mb-6 opacity-90 max-w-2xl mx-auto">
              Start parkering når du ankommer og stopp når du drar. Du betaler kun for faktisk parkeringstid, minutt for minutt.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/auth/signin"
                className="inline-block px-8 py-4 bg-white text-purple-600 rounded-xl hover:bg-gray-100 transition-all font-semibold text-lg shadow-lg hover:shadow-xl transform hover:scale-105"
              >
                Logg inn for å starte
              </Link>
              <Link
                href="/auth/signup"
                className="inline-block px-8 py-4 bg-white/10 text-white border-2 border-white rounded-xl hover:bg-white/20 transition-all font-semibold text-lg"
              >
                Opprett konto
              </Link>
            </div>
