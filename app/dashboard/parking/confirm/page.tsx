...
function ConfirmParkingPageContent() {
  ...
  }, [parkingSpot, vehiclePlate, userLocation])
      ...
      <main className="max-w-2xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
          ...
          <div className="space-y-6">
              ...
              <div className="flex items-center gap-2">
                {gpsVerified ? (
                  <>
                    ...
                    <span className="text-sm text-green-600">Lokasjon bekreftet</span>
                  </>
                ) : (
                  <>
                    ...
                    <span className="text-sm text-yellow-600">Du er ikke nær nok området</span>
                  </>
                )}
              </div>
            )}
            ...
            <button
              onClick={handleStart}
              disabled={!canStart || !vehiclePlate || preparing}
